...
#echo THING_NAME=mimamori_pi >> ./cron_mod.conf
THING_NAME=mimamori_pi
...
echo CACERT=AmazonRootCA1.pem >> cron_mod.conf
echo CLIENTCERT=${THING_NAME}-certificate.pem.crt >> cron_mod.conf
echo CLIENTKEY=${THING_NAME}-private.pem.key >> cron_mod.conf
echo >> cron_mod.conf
...
echo export CACERT=AmazonRootCA1.pem >> ../.profile
echo export CLIENTCERT=${THING_NAME}-certificate.pem.crt >> ../.profile
echo export CLIENTKEY=${THING_NAME}-private.pem.key >> ../.profile
echo >> ../.profile
